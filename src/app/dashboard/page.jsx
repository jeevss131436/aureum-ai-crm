        ...
        <div className="flex items-center gap-5">
          ...
          <div>
            ...
            <div className="flex items-center gap-2 mb-2">
              <span className="text-xs text-white/50 uppercase tracking-wide">Current Plan:</span>
              {isTeam ? (
                <span className="inline-flex items-center gap-1.5 px-2.5 py-1 bg-blue-500/20 border border-blue-400/30 text-blue-300 text-xs font-semibold rounded-lg">
                ...
                <span className="inline-flex items-center gap-1.5 px-2.5 py-1 bg-gray-500/20 border border-gray-400/30 text-gray-300 text-xs font-semibold rounded-lg">
                  <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
